...
import com.zfj123.mobilesafe.utils.MD5Utils;
...
//		dialog=builder.show();
	...
	private EditText et_setup_comfirm;
	private Button ok;
	 ...
	 * 设置密码对话框
	 */
	private void showSetuoPwdDialog() {
		AlertDialog.Builder builder=new Builder(HomeActivity.this);
		//自定义一个布局文件
		View view = View.inflate(HomeActivity.this	,R.layout.dialog_setup_password	, null);
		et_setup_pwd=(EditText) view.findViewById(R.id.et_setup_pwd);
		et_setup_comfirm=(EditText) view.findViewById(R.id.et_setup_comfirm);
		ok=(Button) view.findViewById(R.id.ok);
		cancel=(Button) view.findViewById(R.id.cancel);
		cancel.setOnClickListener(new OnClickListener() {
		...
		ok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//取出密码
				String password = et_setup_pwd.getText().toString().trim();
				String password_confirm = et_setup_comfirm.getText().toString().trim();
				...
				if (password.equals(password_confirm)) {
					//一致，则保存密码，把对话框取消，并且进入手机防盗页面
					Editor editor = sp.edit();
					editor.putString("password", MD5Utils.md5Password(password));
					editor.commit();
					dialog.dismiss();
					Log.i(Tag,"一致，则保存密码，把对话框取消，并且进入手机防盗页面" );
				}else{
